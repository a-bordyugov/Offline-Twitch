...
Легко: Положительные голосования имеют высокий приоритет. Чаще всего вам будут выпадать: аптечки, зелья и т.п.
	...
	set_tw_difficulty_preset_descr_hardest = {
		en = "Very hard",
		ru = "Очень сложно",
		zh = "",
	},
	set_tw_difficulty_preset_descr_hard = {
		en = "Hard",
		ru = "Сложно",
		zh = "",
	},
	set_tw_difficulty_preset_descr_normal = {
		en = "Normal",
		ru = "Нормально",
		zh = "",
	},
	set_tw_difficulty_preset_descr_easy = {
		en = "Easy",
		ru = "Легко",
		zh = "",
	},
